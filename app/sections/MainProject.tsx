            ...
            >
              <div className="lg:grid lg:grid-cols-2 lg:gap-16">
                <div className="lg:pb-16">
                  <div className="flex-col md:flex-row gap-2 bg-gradient-to-r from-emerald-300 to-sky-400 inline-flex font-bold uppercase tracking-widest text-sm text-transparent bg-clip-text">
                    <p className="gap-2">{project.company}</p>
                    <p>&bull;   {project.year}</p>
                  </div>
                  ...
                  <p className="flex gap-2 text-sm md:text-base text-white/50 mt-5">{project.results}</p>
                  {/* <ul
                    key={project.title}
